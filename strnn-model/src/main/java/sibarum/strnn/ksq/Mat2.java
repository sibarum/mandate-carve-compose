...
/**
 * Tiny 2x2 real matrix helpers. KSQ runs the M_2(R) representation of the
 * split-quaternion algebra; every algebraic operation reduces to a 2x2 matmul.
 *
 * Matrices are stored as {@code double[2][2]}, row-major. No allocation in the
 * inner-loop hot path beyond the result matrix itself.
 */
public final class Mat2 {

    private Mat2() {}

    /** Returns the 2x2 identity. */
