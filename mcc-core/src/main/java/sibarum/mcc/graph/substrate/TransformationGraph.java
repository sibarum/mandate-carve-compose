...
/**
 * Slowly-shaped substrate of the framework. Holds the set of
 * {@link TransformationNode}s and {@link TransformationEdge}s and
 * supports the type-indexed lookups a node-editor or carver needs.
 */
public final class TransformationGraph {
    ...
    /**
     * Find the edge {@code from → to}, if it exists. Returns null otherwise.
     */
